...
def SH_PostTrainInit(type_name):
    ...
    parser.add_argument('--config', type=str, default='config/Source_Flow_softmax_topkpoint_topmask_fuse_mix.yaml',
                        help='config file')
...
if __name__ == "__main__":
    ...
    args_g, io_g = SH_PostTrainInit("Post_Train_Hamlyn_no_rotation_75_datiao_qiuqiu_1")
