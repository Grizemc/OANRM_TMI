...
if __name__ == "__main__":
    ...
    args_g, io_g = SH_PostTrainInit("Post_Train_Hamlyn_no_rotation_85_datiao_qiuqiu_deform")
    ...
    #     batch_size=1)
    test_hamlyn_loader = DataLoader(HamlynArtificialFPFH(
        root="/big_data/szm/H8amlyn_8192_Mask_3332_new_mutual_85_bigdeform/test",
        fpfh_path="/big_data/szm/H8amlyn_8192_Mask_3332_new_mutual_85_bigdeform/fpft_file/fpft_file",
        sample_num=sample_num, normalize=False, continuous=True),
        batch_size=1)
