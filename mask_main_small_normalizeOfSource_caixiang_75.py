...
def init():
    ...
    parser.add_argument('--config', type=str, default='/home/szm/Paconv_730/config/Source_Flow_softmax_topkpoint_topmask_fuse_8192_75.yaml',
                        help='config file')
...
def main(args, io, writer):
    ...
    if args.resume is not None:
        ...
        starting_epoch = 82   # checkpoint['epoch'] + 1
