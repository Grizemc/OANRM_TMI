...
if __name__ == "__main__":
    ...
    sample_num = 1467 # 670 100
    mask_truncation = 0.9
    g_type_name = 'Stereo_P2-5Fpfh{}_{}'.format(sample_num,21)

    train_loader = DataLoader(
        StereoFpfh(root=r"/big_data/szm/cwz_stereomis_P2-5_0.5", sample_num=sample_num,
                  fpfh=True, normalize=False, interval=21), batch_size=1)
