...
def GenerateDataset(file_list):
    # target_path = r"/big_data/szm/szm_MICCAI_Hamlyn/MICCAI_8192_Train"
    target_path = r"/big_data/szm/H8amlyn_8192_Mask_3332_new_mutual_90_bigdeform/test"
    ...
    for file in file_list:
        ...
        try:
            ...
            # 下采样  0.05, 0.1  0.2 0.15
            index_percentage = np.random.uniform(0.05, 0.1)
