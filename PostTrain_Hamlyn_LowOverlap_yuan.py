...
def SH_PostTrainInit(type_name):
    ...
    if not os.path.exists('checkpoints/' + args.exp_name + '/' + type_name + '/npz_result1'):
        os.makedirs('checkpoints/' + args.exp_name + '/' + type_name + '/npz_result1')
    io = IOStream('checkpoints/' + args.exp_name + '/' + type_name + '/post_train1.log')
...
def post_train_main(model, args, io, sample_num, data, loss_fn):
    ...
    if nn_count > 3:
        ...
        if temp_true_false and args.need_fpfh:
            ...
            save_path = 'checkpoints/{}/{}/npz_result1/post_train_sample_num_{}_best.npz'.format(
...
if __name__ == "__main__":
    args_g, io_g = SH_PostTrainInit("Post_Train_Hamlyn_no_rotation_80")
