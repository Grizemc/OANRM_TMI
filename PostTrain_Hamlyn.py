...
if __name__ == "__main__":
    args_g, io_g = SH_PostTrainInit("Post_Train_Hamlyn_no_rotation_can_be_delete")
    # sample_num = [0, 900] # 1793
    sample_num = "None" # 1793
    mask_truncation = 0.9
    train_loader = DataLoader(HamlynArtificialFPFH(sample_num=sample_num, normalize=False, continuous=True),
                              batch_size=1)
    ...
    for index, data in loop:
        ...
        save_path = 'checkpoints/{}/{}/{}_index_{}'.format(str(args_g.exp_name), str(args_g.type_name),
