...
def init():
    ...
    parser.add_argument('--config', type=str, default='/home/szm/Paconv_730/config/Cache/Flow_softmax_topkpoint_topmask_fuselrhigh2_gtfactor_3_90_6.yaml',
                        help='config file')
...
def train_one_epoch(model, optimizer, epoch, args):
    ...
    print("gt_loss_sum", gt_loss_sum)
    print("mask_loss_sum", mask_loss_sum)
    acc = acc / (index + 1) * 100
