...
if __name__ == "__main__":
    ...
    post_train = r"D:\try\try\szmCode\paconv_\duibi_keshihua\huaxi_keshihua_lndp"
    ...
    print("file:", file)
    npz = np.load(file)
    point1 = npz['source_points1'].squeeze()
    point2 = npz['source_points2'].squeeze()
    # pred_xyz = npz['pred_xyz'].squeeze()
    pred_xyz = npz['pred_pcd'].squeeze()

    # pred_mask1 = npz['pred_mask1'].squeeze()
    # pred_mask2 = npz['pred_mask2'].squeeze()
    color1 = npz['source_colors1'].squeeze()
    color2 = npz['source_colors2'].squeeze()
