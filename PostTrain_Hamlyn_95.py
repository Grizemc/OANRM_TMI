...
class Human_SelfSupervise_mask:
    ...
    def post_losscal_hamlyn_mask(self, l_xyz1, l_new_xyz, xyz2, color1, color2, l_mask1, l_mask2, mask_pseudo1,
        ...
        if mask_pseudo1.sum == 0:
            ...
            print("gt_pseudo_loss", gt_pseudo_loss)
...
def SH_PostTrainInit(type_name):
    ...
    parser.add_argument('--config', type=str, default='config/Source_Flow_softmax_topkpoint_topmask_fuse_8192_90_4.yaml',
                        help='config file')
...
if __name__ == "__main__":
    args_g, io_g = SH_PostTrainInit("Post_Train_Hamlyn_no_rotation_95")
