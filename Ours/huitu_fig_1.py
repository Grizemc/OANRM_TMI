...
if __name__ == "__main__":
    ...
    post_train = r"D:\try\try\szmCode\paconv_\duibi_keshihua\huaxi_keshihua_95_traindataset"
    ...
    # pred_mask1_bool= pred_mask1 > 0.9
    ...
    pred_mask2_bool = pred_mask2 > 0.9
    color_pred_mask2 = np.copy(color2)
    color_pred_mask2[pred_mask2_bool, 0] = 0  # 绿色
    color_pred_mask2[pred_mask2_bool, 1] = 1
    color_pred_mask2[pred_mask2_bool, 2] = 0
    color_pred_mask2[~pred_mask2_bool, 0] = 1  # 深红色
    color_pred_mask2[~pred_mask2_bool, 1] = 0
    color_pred_mask2[~pred_mask2_bool, 2] = 0
